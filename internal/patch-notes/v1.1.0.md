# v1.1.0 — released 2026-09-20

Everything merged to `master` between v1.0.1 and this release. Newest
first. Each entry is terse — full root-cause writeups live in
[`DEVLOG.md`](../../DEVLOG.md), the fast-scan bug index in
[`BUGS.md`](../../BUGS.md). The condensed version of this list is what
shipped as the GitHub Release's own notes.
